...
- **Separation from tutorials/resources**
...
- **Community-driven curation**
  ...
  - Contribution guidelines available via `CONTRIBUTING.md` for community submissions and updates.

- **Open source repository**
  - Hosted on GitHub with visible history, contributors, and license.
  - Distributed under an open-source license (`LICENSE` file in repo).
