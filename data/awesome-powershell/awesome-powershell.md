...
- **GitHub Actions workflow:** `markdownLinkDaily.yml` badge indicates automated, scheduled link verification.
- **Dead link analysis script:** `DeadLinksAnalyzer.ps1` included to assist in detecting and maintaining valid links.
- **.github/workflows directory:** Stores CI configuration for the repository.
