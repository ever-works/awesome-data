...
### Scope and Purpose
- Curated list focused specifically on High Performance Computing (HPC).
- Aimed at both engineers and system administrators working with clusters, supercomputers, and large-scale workloads.
- Covers both open-source and proprietary tools.
- Includes a broad range of software licenses (GPL, BSD, MIT, Apache, EPL, LGPL, proprietary, etc.).
...
- Clearly defined **contribution guidelines** in `contributing.md` for adding or updating entries.
- Additional documents like `developing.md` and `emerging.md` for project development practices and emerging HPC tools/topics.
- Licensed repository with an explicit `LICENSE` file for the list itself.

## Pricing

- Not applicable. Awesome HPC is an open, curated list hosted on GitHub and does not present pricing plans for access to the list itself.
